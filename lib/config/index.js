'use strict';
/**
 * Manages the internal config of nodangel, checking for the state of support
 * with fs.watch, how nodangel can watch files (using find or fs methods).
 *
 ...
 * look for local and global nodangel.json files and merge together the final
 * settings with the config for nodangel.
 *
 * @param  {Object} settings user defined settings for nodangel (typically on
 *  the cli)
